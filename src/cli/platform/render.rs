...
fn render_help(frame: &mut ratatui::Frame<'_>, area: Rect) {
    let lines = vec![
        ...
        Line::from("p opens capability-driven actions, including lease-authorized live steering"),
        Line::from("Enter previews the exact action and target; y executes; n cancels"),
